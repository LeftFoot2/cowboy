...
-define(gpb_descriptor_gpb_version, "4.13.0").
...
-record('DescriptorProto.ExtensionRange',
        {start                  :: integer() | undefined, % = 1, 32 bits
         ...
         options                :: gpb_descriptor:'ExtensionRangeOptions'() | undefined % = 3
        }).
-endif.
...
-record('FieldDescriptorProto',
        {name                   :: iodata() | undefined, % = 1
         ...
         proto3_optional        :: boolean() | 0 | 1 | undefined % = 17
        }).
-endif.
...
-record('OneofDescriptorProto',
        {name                   :: iodata() | undefined, % = 1
         options                :: gpb_descriptor:'OneofOptions'() | undefined % = 2
        }).
-endif.
...
-record('EnumDescriptorProto',
        {name                   :: iodata() | undefined, % = 1
         ...
         reserved_range = []    :: [gpb_descriptor:'EnumDescriptorProto.EnumReservedRange'()] | undefined, % = 4
         reserved_name = []     :: [iodata()] | undefined % = 5
        }).
-endif.
...
-record('FileOptions',
        {java_package           :: iodata() | undefined, % = 1
         ...
         java_generate_equals_and_hash :: boolean() | 0 | 1 | undefined, % = 20
         ...
         php_generic_services = false :: boolean() | 0 | 1 | undefined, % = 42
         deprecated = false     :: boolean() | 0 | 1 | undefined, % = 23
         cc_enable_arenas = true :: boolean() | 0 | 1 | undefined, % = 31
         objc_class_prefix      :: iodata() | undefined, % = 36
         csharp_namespace       :: iodata() | undefined, % = 37
         swift_prefix           :: iodata() | undefined, % = 39
         php_class_prefix       :: iodata() | undefined, % = 40
         php_namespace          :: iodata() | undefined, % = 41
         php_metadata_namespace :: iodata() | undefined, % = 44
         ruby_package           :: iodata() | undefined, % = 45
         uninterpreted_option = [] :: [gpb_descriptor:'UninterpretedOption'()] | undefined % = 999
        }).
-endif.
...
-record('MethodOptions',
        {deprecated = false     :: boolean() | 0 | 1 | undefined, % = 33
         idempotency_level = 'IDEMPOTENCY_UNKNOWN' :: 'IDEMPOTENCY_UNKNOWN' | 'NO_SIDE_EFFECTS' | 'IDEMPOTENT' | integer() | undefined, % = 34, enum MethodOptions.IdempotencyLevel
         uninterpreted_option = [] :: [gpb_descriptor:'UninterpretedOption'()] | undefined % = 999
        }).
-endif.
